...
pub fn run() {
    ...
    builder = builder.invoke_handler(tauri::generate_handler![
        ...
        git::status::git_stage_files,
        git::status::git_stage_all,
        git::status::git_unstage_file,
        git::status::git_unstage_files,
        ...
        git::history::git_diff_between_commits,
        git::history::git_diff_files,
        git::history::git_show_file,
        ...
        git::repo::git_get_repo_info,
        git::repo::git_get_config,
        git::repo::git_set_config,
        git::repo::git_stage,
