                  ...
                  <div className="flex items-center gap-3">
                    <Switch
                      ...
                      onCheckedChange={(enabled) =>
                        handleToggleEnabled(selectedAgentData.id, enabled)
                      }
                    />
                    <button
                  ...
                  <div className="p-4 bg-background/30 rounded-xl border border-border/30">
                    <div className="text-2xl font-bold">
                      {selectedAgentData.successRate
                        ? `${(selectedAgentData.successRate * 100).toFixed(0)}%`
                        : "N/A"}
                    </div>
                    <div className="text-xs text-muted-foreground">
                      Success Rate
                    ...
                    <div className="p-4 bg-background/30 rounded-xl border border-border/30">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedAgentData.keywords.map((kw) => (
                          <span
                            key={kw}
                            className="px-2 py-1 text-xs bg-background/50 rounded-md border border-border/30"
                          >
                            {kw}
                          </span>
                        ))}
